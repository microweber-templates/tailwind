            ...
            <div class="bg-gray-900">
                <div class="max-w-7xl mx-auto h-10 px-4 flex items-center justify-between sm:px-6 lg:px-8">
                    <!--                    <div class="hidden lg:block lg:flex-1">
                                            <div class="flex text-white">0885451012</div>
                                        </div>-->
                    <div>
                        <div>
                            <marquee>
                                <p class="flex-1 text-center font-extrabold text-white uppercase lg:flex-none">
                    ...
                    <!--                    <div class="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-6">
                                            <a class="text-sm font-medium text-white hover:text-gray-100" href="/register">
                                                Създай акаунт
                                            </a>
                                            <span class="h-6 w-px bg-gray-600" aria-hidden="true"></span>
                                            <a class="text-sm font-medium text-white hover:text-gray-100" href="/login">
                                                Вход
                                            </a>
                                        </div>-->
                </div>
                                    ...
                                    <div class="h-full flex justify-center">
                                        ...
                                        <div x-data="{showCategoryChildren: false}" class="flex">
                                            <div class="relative flex">
                                                <button x-on:click.outside="showCategoryChildren = false" x-on:click="showCategoryChildren = ! showCategoryChildren"
                                                        class="group transform flex items-center cursor-pointer text-black hover:text-gray-900 pt-4 pb-4 pl-4 pr-4 outline-none font-bold uppercase" type="button">
                                                    <a href="https://artlab.bg/gravirani-led-lampi" x-on:click.prevent="true">
                                                        3D LED лампи
                                                    </a>
                                                    <span class="absolute bottom-0 left-0 w-full h-1 bg-gradient-to-br from-gray-900 to-black opacity-0 transform translate-y-3 group-hover:opacity-100 group-hover:translate-y-0"></span>
                                                </button>
                                                ...
                                                <div class="relative bg-white">
                                                    <div class="max-w-screen-xl mx-auto px-8">
                                                        <div class="grid grid-cols-6 items-start gap-y-3 gap-x-3 pt-3 pb-3">
                                                            ...
                                                            <div class="group relative aspect-w-1 aspect-h-1 rounded-md bg-gray-100 overflow-hidden">
                                                                <img src="https://artlab.bg/storage/thumbnails/quality-90-resize-0555495a889c269c9ca4482aa855bffe-300x300.jpg" alt="https://artlab.bg/storage/thumbnails/quality-90-resize-0555495a889c269c9ca4482aa855bffe-300x300.jpg" class="object-center object-cover group-hover:opacity-75">
                                                                <div class="flex flex-col justify-end">
                                                                    <div class="p-4 bg-black bg-opacity-60 text-sm">
                                                                        <a class="font-medium uppercase text-white" href="https://artlab.bg/3d-led-lampi-za-vlyubeni">
                                                                            <span class="absolute inset-0"></span>
                                                                            3D led лампи за влюбени
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="group relative aspect-w-1 aspect-h-1 rounded-md bg-gray-100 overflow-hidden">
                                                                <img src="https://artlab.bg/storage/thumbnails/quality-90-resize-d2c6f81078b210a739a74e31e7dbb3bc-300x300.jpg" alt="https://artlab.bg/storage/thumbnails/quality-90-resize-d2c6f81078b210a739a74e31e7dbb3bc-300x300.jpg" class="object-center object-cover group-hover:opacity-75">
                                                                <div class="flex flex-col justify-end">
                                                                    <div class="p-4 bg-black bg-opacity-60 text-sm">
                                                                        <a class="font-medium uppercase text-white" href="https://artlab.bg/3d-led-lampi-za-deca">
                                                                            <span class="absolute inset-0"></span>
                                                                            3D led лампи за деца
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="group relative aspect-w-1 aspect-h-1 rounded-md bg-gray-100 overflow-hidden">
                                                                <img src="https://artlab.bg/storage/thumbnails/quality-90-resize-31170fa8b812fb3ad9aba16f7cff245e-300x300.png" alt="https://artlab.bg/storage/thumbnails/quality-90-resize-31170fa8b812fb3ad9aba16f7cff245e-300x300.png" class="object-center object-cover group-hover:opacity-75">
                                                                <div class="flex flex-col justify-end">
                                                                    <div class="p-4 bg-black bg-opacity-60 text-sm">
                                                                        <a class="font-medium uppercase text-white" href="https://artlab.bg/3d-led-lampi-za-zhenata">
                                                                            <span class="absolute inset-0"></span>
                                                                            3D led лампи за жени
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="group relative aspect-w-1 aspect-h-1 rounded-md bg-gray-100 overflow-hidden">
                                                                <img src="https://artlab.bg/storage/thumbnails/quality-90-resize-face579fe69f84df348381317440dbc3-300x300.png" alt="https://artlab.bg/storage/thumbnails/quality-90-resize-face579fe69f84df348381317440dbc3-300x300.png" class="object-center object-cover group-hover:opacity-75">
                                                                <div class="flex flex-col justify-end">
                                                                    <div class="p-4 bg-black bg-opacity-60 text-sm">
                                                                        <a class="font-medium uppercase text-white" href="https://artlab.bg/3d-led-lampi-za-mazhe">
                                                                            <span class="absolute inset-0"></span>
                                                                            3D led лампи за мъже
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="group relative aspect-w-1 aspect-h-1 rounded-md bg-gray-100 overflow-hidden">
                                                                <img src="https://artlab.bg/storage/thumbnails/quality-90-resize-3144580eebb94f3a4636c1ddd925d0dd-300x300.jpg" alt="https://artlab.bg/storage/thumbnails/quality-90-resize-3144580eebb94f3a4636c1ddd925d0dd-300x300.jpg" class="object-center object-cover group-hover:opacity-75">
                                                                <div class="flex flex-col justify-end">
                                                                    <div class="p-4 bg-black bg-opacity-60 text-sm">
                                                                        <a class="font-medium uppercase text-white" href="https://artlab.bg/3d-led-lampi-ilyuzii">
                                                                            <span class="absolute inset-0"></span>
                                                                            3D led лампи - илюзии
                                                                        </a>
                                                                    </div>
                                                            ...
                                                            <div class="group relative aspect-w-1 aspect-h-1 rounded-md bg-gray-100 overflow-hidden">
                                                                <img src="https://artlab.bg/storage/thumbnails/quality-90-resize-09a22f6d7fd871b8c28ede6f368cd379-300x300.jpg" alt="https://artlab.bg/storage/thumbnails/quality-90-resize-09a22f6d7fd871b8c28ede6f368cd379-300x300.jpg" class="object-center object-cover group-hover:opacity-75">
                                                                <div class="flex flex-col justify-end">
                                                                    <div class="p-4 bg-black bg-opacity-60 text-sm">
                                                                        <a class="font-medium uppercase text-white" href="https://artlab.bg/3d-led-lampi-za-vseki">
                                                                            <span class="absolute inset-0"></span>
                                                                            3D led лампи за всеки
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="group relative aspect-w-1 aspect-h-1 rounded-md bg-gray-100 overflow-hidden">
                                                                <img src="https://artlab.bg/storage/thumbnails/quality-90-resize-7bdac0dc7fa8bbc9b6bb6078af0d173e-300x300.png" alt="https://artlab.bg/storage/thumbnails/quality-90-resize-7bdac0dc7fa8bbc9b6bb6078af0d173e-300x300.png" class="object-center object-cover group-hover:opacity-75">
                                                                <div class="flex flex-col justify-end">
                                                                    <div class="p-4 bg-black bg-opacity-60 text-sm">
                                                                        <a class="font-medium uppercase text-white" href="https://artlab.bg/3d-led-lampi-futbolni">
                                                                            <span class="absolute inset-0"></span>
                                                                            3D led лампи - футболни
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="group relative aspect-w-1 aspect-h-1 rounded-md bg-gray-100 overflow-hidden">
                                                                <img src="https://artlab.bg/storage/thumbnails/quality-90-resize-99820eea64c5a62eb9fe67f507c1dfee-300x300.webp" alt="https://artlab.bg/storage/thumbnails/quality-90-resize-99820eea64c5a62eb9fe67f507c1dfee-300x300.webp" class="object-center object-cover group-hover:opacity-75">
                                                                <div class="flex flex-col justify-end">
                                                                    <div class="p-4 bg-black bg-opacity-60 text-sm">
                                                                        <a class="font-medium uppercase text-white" href="https://artlab.bg/gravirani-led-lampi">
                                                                            <span class="absolute inset-0"></span>
                                                                            Виж всички
                                                                        </a>
                                                                    </div>
                                        ...
                                        <div x-data="{showCategoryChildren: false}" class="flex">
                                            <div class="relative flex">
                                                <button x-on:click.outside="showCategoryChildren = false" x-on:click="showCategoryChildren = ! showCategoryChildren"
                                                        class="group transform flex items-center cursor-pointer text-black hover:text-gray-900 pt-4 pb-4 pl-4 pr-4 outline-none font-bold uppercase" type="button">
                                                    <a href="https://artlab.bg/dekoracii" x-on:click.prevent="true">
                                                        Декорации
                                                    </a>
                                                    <span class="absolute bottom-0 left-0 w-full h-1 bg-gradient-to-br from-gray-900 to-black opacity-0 transform translate-y-3 group-hover:opacity-100 group-hover:translate-y-0"></span>
                                                </button>
                                                ...
                                                <div class="relative bg-white">
                                                    <div class="max-w-screen-xl mx-auto px-8">
                                                        <div class="grid grid-cols-6 items-start gap-y-3 gap-x-3 pt-3 pb-3">
                                                            ...
                                                            <div class="group relative aspect-w-1 aspect-h-1 rounded-md bg-gray-100 overflow-hidden">
                                                                <img src="https://artlab.bg/storage/thumbnails/quality-90-resize-9af99ba9fd22b24d0e87aa980c96acc7-300x300.jpg" alt="https://artlab.bg/storage/thumbnails/quality-90-resize-9af99ba9fd22b24d0e87aa980c96acc7-300x300.jpg" class="object-center object-cover group-hover:opacity-75">
                                                                <div class="flex flex-col justify-end">
                                                                    <div class="p-4 bg-black bg-opacity-60 text-sm">
                                                                        <a class="font-medium uppercase text-white" href="https://artlab.bg/pana-skandinavski-muh">
                                                                            <span class="absolute inset-0"></span>
                                                                            Скандинавски мъх
                                                                        </a>
                                                                    </div>
                                                            ...
                                                            <div class="group relative aspect-w-1 aspect-h-1 rounded-md bg-gray-100 overflow-hidden">
                                                                <img src="https://artlab.bg/storage/thumbnails/quality-90-resize-cf103411f8fed6e292daeff0856d3966-300x300.jpg" alt="https://artlab.bg/storage/thumbnails/quality-90-resize-cf103411f8fed6e292daeff0856d3966-300x300.jpg" class="object-center object-cover group-hover:opacity-75">
                                                                <div class="flex flex-col justify-end">
                                                                    <div class="p-4 bg-black bg-opacity-60 text-sm">
                                                                        <a class="font-medium uppercase text-white" href="https://artlab.bg/dekoracii">
                                                                            <span class="absolute inset-0"></span>
                                                                            Виж всички
                                                                        </a>
                                                                    </div>
